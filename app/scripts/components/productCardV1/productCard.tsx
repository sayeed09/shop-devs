    ...
    <>
      <div className={`product-card-box-v1 product-card-v1 ${item?.productId}${className ? (" " + className) : ''}`}>
        ...
        <a className="product-img-v1"
          ...
          role=''
          href={disableRedirect ? undefined : `/products/${item?.handle}?variant=${item.variantId}`}
        >
        ...
        <div className="product-card-box-v1-dtl">
          <a href={disableRedirect ? undefined : `/products/${item?.handle}?variant=${item.variantId}`}
          >
            {item.averageRating &&
              <GeneratedStarView
                reviewDetails={item}
